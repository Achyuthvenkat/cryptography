...
/**
 * Excel to PDF — converts XLS/XLSX spreadsheets to PDF.
 */
class ExcelToPdfActivity : BasePdfActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvConvertTitle.setText(R.string.feature_excel_to_pdf)
        binding.tvConvertDescription.setText(R.string.desc_excel_to_pdf)
        binding.btnSelectFile.setOnClickListener { launchExcelPicker() }
    ...
    private fun convert() {
        ...
        runWithProgress(binding.progressBar) {
            ...
            ConversionUtils.excelToPdf(this, uri, out)
            out
        }
    }
}
