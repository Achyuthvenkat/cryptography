...
/**
 * PDF to Excel — extracts tabular data from a PDF into XLSX.
 */
class PdfToExcelActivity : BasePdfActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.tvConvertTitle.setText(R.string.feature_pdf_to_excel)
        binding.tvConvertDescription.setText(R.string.desc_pdf_to_excel)
    ...
    private fun convert() {
        ...
        runWithProgress(binding.progressBar) {
            val out = outputFile("converted_${System.currentTimeMillis()}.xlsx")
            ConversionUtils.pdfToExcel(this, uri, out)
            out
        }
    }
}
